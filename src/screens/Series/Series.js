...
componentDidMount() {
    ...
    fetch(`https://api.themoviedb.org/3/tv/${this.props.match.params.contenido}?api_key=ed2a98f264a93feb2092da91d83e35a3`)
...
cargarMas(){
    console.log(this.props)
    fetch(`https://api.themoviedb.org/3/tv/${this.props.match.params.contenido}?api_key=ed2a98f264a93feb2092da91d83e35a3&page=${this.state.page}` )
      .then((response) => response.json())
      .then((data) => {
        console.log(data)
